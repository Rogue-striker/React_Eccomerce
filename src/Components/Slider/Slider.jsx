    ...
    return (
        <><div className="w-full flex items-center justify-center relative transition-all md:mt-12 mt-6">
            ...
            <div>
                ...
                <Link to='/products'>
                    <button className="absolute left-1/2 bottom-3 sm:bottom-32 transform -translate-x-1/2 -translate-y-1/2 w-fit px-1.5 py-1 sm:w-48 bg-white md:px-3 md:py-3 rounded shadow-2xl sm:text-xl border-slate-800 font-lato hover:scale-110 transition ease-in-out delay-150 duration-200 hover:bg-blue-600 hover:text-white">
                        Shop Now </button>
                </Link>
